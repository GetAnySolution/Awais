                  ...
                  ?>
                    ...
                    <ul class="nav nav-category" id="categoryCollapseMenu">
                      <li class="nav-item border-bottom w-100 collapsed" data-bs-toggle="collapse" data-bs-target="#categoryFlush<?php echo $row['id'] ?>" aria-expanded="false" aria-controls="categoryFlush<?php echo $row['id'] ?>"><a href="#" class="nav-link">
                        ...
                        <!-- accordion collapse -->
                        <div id="categoryFlush<?php echo $row['id'] ?>" class="accordion-collapse collapse" data-bs-parent="#categoryCollapseMenu">
                          <div>
                            <!-- nav -->
                            ...
                            <ul class="nav flex-column ms-3">
                              ...
                              while ($productArr = mysqli_fetch_assoc($productsRes)) { ?>
                                <!-- nav item -->
                                <li class="nav-item"><a href="#!" class="nav-link"><?php echo $productArr['name'] ?></a></li>
                                <!-- nav item -->
                              <?php } ?>
